...
ActiveRecord::Schema.define(version: 20151221190806) do
  ...
  create_table "answer_generators", force: :cascade do |t|
  ...
  add_index "answers", ["question_id", "body"], name: "index_answers_on_question_id_and_body", unique: true, using: :btree
